...
//            }
//        }
//        if(c == prefix.charAt(prefix.length() -1)) return true;
//        else return false;
//    }

    public boolean hasPrefixMatch(String prefix) {
        Node x = get(root, prefix, 0);
        if (x == null) return false;
        else return true;
        //return findAnyPrefix(root, prefix, 0);
    }
